...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[102] = {
	...
	{(const void *)0x8003fbf, (ISR)0x8000e7d}, /* 6 */
	{(const void *)0x8003fbd, (ISR)0x8000e7d}, /* 7 */
	{(const void *)0x8003fbb, (ISR)0x8000e7d}, /* 8 */
	{(const void *)0x8003fb9, (ISR)0x8000e7d}, /* 9 */
	{(const void *)0x8003fb7, (ISR)0x8000e7d}, /* 10 */
	...
	{(const void *)0x8003fb5, (ISR)0x8000e7d}, /* 23 */
	...
	{(const void *)0x8003fb3, (ISR)0x8000e7d}, /* 40 */
